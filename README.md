<p align="center">
  <img src="banner.svg" alt="Claude Market Skills by KM — by Kreative Minds" width="100%">
</p>p>
...
**Built by [Kreative Minds](https://kreativeminds.ae) for entrepreneurs, agency builders, and solopreneurs who want to sell marketing services powered by AI.**
...
```bash
curl -fsSL https://raw.githubusercontent.com/khalidgraphy/claude-market-skills-by-KM/main/install.sh | bash
```
...
2. 2. **Claude reads the skill files** — they tell Claude exactly how to analyze the site
   3. 3. **5 subagents launch in parallel** — each one analyzes a different dimension
      4. 4. **Python scripts run** — automated page analysis, competitor scanning
         5. 5. **Results are compiled** — into a scored, prioritized, actionable report
            6. 6. **Output is saved** — as a Markdown file or professional PDF
              
               7. ---
              
               8. ## Use Cases
              
               9. ### For Agency Builders
               10. - Run `/market audit` on a prospect's website before a sales call
                             ...
                             - - Research competitors with `/market competitors`
                               - - Plan launches with `/market launch`
                                 - - Analyze your funnel with `/market funnel`
                                   ...
                                   **[Visit Kreative Minds](https://kreativeminds.ae)** — AI-powered digital strategy, marketing automation, and creative solutions.

                                   ---

                                   ## License

                                   Custom Non-Commercial License — personal use only, credit required. See [LICENSE](LICENSE) for full terms.

                                   ---

                                   **Maintained by [Kreative Minds](https://kreativeminds.ae) — Founded by [Khalid Mir](https://khalidmir.com)**
